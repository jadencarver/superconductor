...
const SCSS_PATH: &Path = Path::new("assets/__pm.scss");

/// DEPRECATED
pub fn panel_xslt() -> String {
    warn!("This method is deprecated");
    format!("{}{}", XML, (PanelXslt {}).to_string())
}

markup::define! {
    PanelXslt {
        @match compile_scss_file(SCSS_PATH, OutputStyle::Compressed) {
            Ok(css) => {
...
//    TemplateRoot {
//        {TemplateForm {css: css}}
//        {TemplateTasks {}}
//        {TemplateLogs {}}
//    }
//
//    TemplateForm(css: String) {
//        // BEGINS FORM  ------------------
//        xsl:template match="/" {
//            div#__pm__panel {
